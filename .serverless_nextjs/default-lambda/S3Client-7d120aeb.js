...
var fs = require('fs');
require('http2');
var index = require('./index-53bc5aa3.js');
require('url');
require('buffer');
require('http');
require('os');
...
const ClientDefaultValues = {
    ...
    maxAttempts: defaultRoleAssumers.loadConfig(defaultRoleAssumers.NODE_MAX_ATTEMPT_CONFIG_OPTIONS),
    ...
    retryModeProvider: defaultRoleAssumers.loadConfig(defaultRoleAssumers.NODE_RETRY_MODE_CONFIG_OPTIONS),
