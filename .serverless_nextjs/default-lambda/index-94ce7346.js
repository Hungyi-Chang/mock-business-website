...
var defaultRoleAssumers = require('./defaultRoleAssumers-85c0b8c3.js');
require('http2');
require('stream');
 ...
 * @internal
 */
var ClientDefaultValues = serdePlugin.__assign(serdePlugin.__assign({}, ClientSharedValues), { runtime: "node", base64Decoder: defaultRoleAssumers.fromBase64, base64Encoder: defaultRoleAssumers.toBase64, bodyLengthChecker: defaultRoleAssumers.calculateBodyLength, credentialDefaultProvider: defaultRoleAssumers.decorateDefaultCredentialProvider(defaultRoleAssumers.defaultProvider), defaultUserAgentProvider: defaultRoleAssumers.defaultUserAgent({
        serviceId: ClientSharedValues.serviceId,
        clientVersion: packageInfo.version,
    }), maxAttempts: defaultRoleAssumers.loadConfig(defaultRoleAssumers.NODE_MAX_ATTEMPT_CONFIG_OPTIONS), md5: defaultRoleAssumers.Hash.bind(null, "md5"), region: defaultRoleAssumers.loadConfig(defaultRoleAssumers.NODE_REGION_CONFIG_OPTIONS, defaultRoleAssumers.NODE_REGION_CONFIG_FILE_OPTIONS), requestHandler: new defaultRoleAssumers.NodeHttpHandler(), retryModeProvider: defaultRoleAssumers.loadConfig(defaultRoleAssumers.NODE_RETRY_MODE_CONFIG_OPTIONS), sha256: defaultRoleAssumers.Hash.bind(null, "sha256"), streamCollector: defaultRoleAssumers.streamCollector, utf8Decoder: defaultRoleAssumers.fromUtf8, utf8Encoder: defaultRoleAssumers.toUtf8 });
...
var deserializeAws_queryMessageSystemAttributeMap = function (output, context) {
    return output.reduce(function (acc, pair) {
        ...
        return serdePlugin.__assign(serdePlugin.__assign({}, acc), (_a = {}, _a[pair["Name"]] = pair["Value"], _a));
    }, {});
};
...
var deserializeAws_queryTagMap = function (output, context) {
    return output.reduce(function (acc, pair) {
        ...
        return serdePlugin.__assign(serdePlugin.__assign({}, acc), (_a = {}, _a[pair["Key"]] = pair["Value"], _a));
    }, {});
};
