...
var serdePlugin = require('./serdePlugin-6d615471.js');
var Url = require('url');
            ...
            return serdePlugin.__awaiter(this, void 0, void 0, function () {
                ...
                return serdePlugin.__generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 4: return [4 /*yield*/, _b.apply(void 0, [serdePlugin.__assign.apply(void 0, _c.concat([(_d.request = _e.sent(), _d)]))])];
                        case 5:
                            output = _e.sent();
...
function httpRequest(options) {
    return new Promise(function (resolve, reject) {
        var req = http.request(serdePlugin.__assign({ method: "GET" }, options));
...
var getMetadataToken = function (options) { return serdePlugin.__awaiter(void 0, void 0, void 0, function () {
    return serdePlugin.__generator(this, function (_a) {
        return [2 /*return*/, httpRequest(serdePlugin.__assign(serdePlugin.__assign({}, options), { host: IMDS_IP, path: IMDS_TOKEN_PATH, method: "PUT", headers: {
...
var getProfile = function (options) { return serdePlugin.__awaiter(void 0, void 0, void 0, function () { return serdePlugin.__generator(this, function (_a) {
    switch (_a.label) {
        case 0: return [4 /*yield*/, httpRequest(serdePlugin.__assign(serdePlugin.__assign({}, options), { host: IMDS_IP, path: IMDS_PATH }))];
...
var getCredentialsFromProfile = function (profile, options) { return serdePlugin.__awaiter(void 0, void 0, void 0, function () {
    ...
    return serdePlugin.__generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _b = (_a = JSON).parse;
                return [4 /*yield*/, httpRequest(serdePlugin.__assign(serdePlugin.__assign({}, options), { host: IMDS_IP, path: IMDS_PATH + profile }))];
            case 1:
            ...
            switch (_f.label) {
                case 0:
                    ...
                    sourceCreds = source_profile
                        ? resolveProfileData(source_profile, profiles, options, serdePlugin.__assign(serdePlugin.__assign({}, visitedProfiles), (_e = {}, _e[source_profile] = true, _e)))
 ...
 * @internal
 */
var ClientDefaultValues$1 = serdePlugin.__assign(serdePlugin.__assign({}, ClientSharedValues$1), { runtime: "node", base64Decoder: fromBase64, base64Encoder: toBase64, bodyLengthChecker: calculateBodyLength, defaultUserAgentProvider: defaultUserAgent({
...
var SSOClient = /** @class */ (function (_super) {
    ...
    function SSOClient(configuration) {
        var _this = this;
        var _config_0 = serdePlugin.__assign(serdePlugin.__assign({}, ClientDefaultValues$1), configuration);
...
var resolveSSOCredentials = function (profileName, profiles, options) { return serdePlugin.__awaiter(void 0, void 0, void 0, function () {
...
var defaultProvider = function (init) {
    if (init === void 0) { init = {}; }
    var options = serdePlugin.__assign({ profile: process.env[ENV_PROFILE$1] }, init);
 ...
 * @internal
 */
var ClientDefaultValues = serdePlugin.__assign(serdePlugin.__assign({}, ClientSharedValues), { runtime: "node", base64Decoder: fromBase64, base64Encoder: toBase64, bodyLengthChecker: calculateBodyLength, credentialDefaultProvider: decorateDefaultCredentialProvider$1(defaultProvider), defaultUserAgentProvider: defaultUserAgent({
...
var STSClient = /** @class */ (function (_super) {
    ...
    function STSClient(configuration) {
        var _this = this;
        var _config_0 = serdePlugin.__assign(serdePlugin.__assign({}, ClientDefaultValues), configuration);
        var _config_1 = resolveRegionConfig(_config_0);
        var _config_2 = resolveEndpointsConfig(_config_1);
        var _config_3 = resolveRetryConfig(_config_2);
        var _config_4 = resolveHostHeaderConfig(_config_3);
